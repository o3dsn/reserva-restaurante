...
public class AvaliacaoController implements AvaliacoesApi {
  ...
  public ResponseEntity<AvaliacaoDTO> atualizarAvaliacao(
      final String id, final AtualizaAvaliacaoDTO body) {
  ...
  @Override
  public ResponseEntity<PaginadaAvaliacaoDTO> buscarAvaliacaoPorIdRestaurante(
      final String id, final Integer pagina, final Integer porPagina) {
    final var input = avaliacaoMapper.fromDTO(new Page(pagina, porPagina), id);
    final var avaliacoes =
        avaliacaoListByIdRestauranteUseCase.execute(input).mapItems(avaliacaoMapper::toDTO);
    final var paginatedAvaliacoes =
        new PaginadaAvaliacaoDTO()
  ...
  @Override
  public ResponseEntity<PaginadaAvaliacaoDTO> buscarAvaliacoes(
      Integer pagina, Integer porPagina, Boolean ativo) {
  ...
  public ResponseEntity<AvaliacaoDTO> cadastrarAvaliacao(
      final String reservaId, final String usuarioId, final CriaAvaliacaoDTO body) {
