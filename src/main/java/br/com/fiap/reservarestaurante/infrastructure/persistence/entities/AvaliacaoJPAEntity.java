...
public class AvaliacaoJPAEntity {
    ...
    public static  AvaliacaoJPAEntity of(final Avaliacao avaliacao) {
        return new AvaliacaoJPAEntity(avaliacao.getId().value(), avaliacao.getReservaId(), avaliacao.getUsuarioId(), avaliacao.getCriacao(), avaliacao.getAlteracao(), avaliacao.getExclusao(), avaliacao.isAtivo(), avaliacao.getComentario(), avaliacao.getNota());
    }
