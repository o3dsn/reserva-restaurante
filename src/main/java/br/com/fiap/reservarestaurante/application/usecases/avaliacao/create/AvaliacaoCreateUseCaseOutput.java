...
public record AvaliacaoCreateUseCaseOutput(
    ...
    public static AvaliacaoCreateUseCaseOutput from(final Avaliacao avaliacao) {
        return new AvaliacaoCreateUseCaseOutput(avaliacao.getId(), avaliacao.getReservaId(), avaliacao.getUsuarioId(), avaliacao.getCriacao(), avaliacao.getAlteracao(), avaliacao.getExclusao(), avaliacao.isAtivo(), avaliacao.getComentario(), avaliacao.getNota());
    }
}
