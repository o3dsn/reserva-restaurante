...
public record AvaliacaoUpdateUseCaseOutput(
    ...
    public static AvaliacaoUpdateUseCaseOutput from(final Avaliacao avaliacao) {
        return new AvaliacaoUpdateUseCaseOutput(avaliacao.getId(), avaliacao.getReservaId(), avaliacao.getUsuarioId(), avaliacao.getCriacao(), avaliacao.getAlteracao(), avaliacao.getExclusao(), avaliacao.isAtivo(), avaliacao.getComentario(), avaliacao.getNota());
    }
