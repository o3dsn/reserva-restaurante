...
public record AvaliacaoListByIdRestauranteUseCaseOutput(
    ...
    public static AvaliacaoListByIdRestauranteUseCaseOutput from(final Avaliacao avaliacao) {
        return new AvaliacaoListByIdRestauranteUseCaseOutput(avaliacao.getId(), avaliacao.getReservaId(), avaliacao.getUsuarioId(), avaliacao.getCriacao(), avaliacao.getAlteracao(), avaliacao.getExclusao(), avaliacao.isAtivo(), avaliacao.getComentario(), avaliacao.getNota());
    }
