...
public class ReservaControllerTest {
  ...
  @Mock private ReservaCreateUseCase reservaCreateUseCase;
  @Mock private ReservaDeleteUseCase reservaDeleteUseCase;
  @Mock private ReservaListUseCase reservaListUseCase;
  @Mock private ReservaGetByIdUseCase reservaGetByIdUseCase;
  @Mock private ReservaUpdateUseCase reservaUpdateUseCase;
  ...
  class Buscar {
    ...
    void devePermitirBuscarTodasReserva() throws Exception {
      var output =
          ReservaListUseCaseOutput.from(
              ReservaHelper.gerarReserva("c8fa8769-33c5-42f0-9466-421880efdee2"));
      ...
      mockMvc
          ...
          .andExpect(
              jsonPath("$.items[0].dataHorarioReserva")
                  .value(output.dataHorarioReserva().getEpochSecond()))
    ...
    void devePermitirBuscarReservaPorId() throws Exception {
      ...
      mockMvc
          ...
          .andExpect(
              jsonPath("$.dataHorarioReserva").value(output.dataHorarioReserva().getEpochSecond()))
