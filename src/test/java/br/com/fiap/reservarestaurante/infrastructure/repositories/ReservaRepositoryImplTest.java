...
public class ReservaRepositoryImplTest {
    ...
    class Atualizar {
        ...
        void devePermitirAtualizarReserva() {
            ...
            when(reservaJPARepository.save(any(ReservaJPAEntity.class))).thenAnswer(i -> i.getArgument(0));
    ...
    class Buscar {
        ...
        void devePermitirBuscarTodasReservas() {
            ...
            var listOfReservaJPAEntity = Arrays.asList(ReservaJPAEntity.of(reserva1), ReservaJPAEntity.of(reserva2));

            when(reservaJPARepository.findAll(any(Pageable.class))).thenReturn(new PageImpl<>(listOfReservaJPAEntity));
        ...
        void devePermitirBuscarReservaPorId() {
            ...
            when(reservaJPARepository.findById(any(String.class))).thenReturn(Optional.of(reservaJPAEntity));
