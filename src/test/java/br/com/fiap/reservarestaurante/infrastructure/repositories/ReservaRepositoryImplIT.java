...
public class ReservaRepositoryImplIT {
    ...
    class Criar {
        ...
        void devePermitirCriarReserva() {
            ...
            assertThat(reservaCriada).extracting(Reserva::getRestauranteId).isEqualTo(reserva.getRestauranteId());
            assertThat(reservaCriada).extracting(Reserva::getUsuarioId).isEqualTo(reserva.getUsuarioId());
            assertThat(reservaCriada).extracting(Reserva::getComentario).isEqualTo(reserva.getComentario());
            assertThat(reservaCriada).extracting(Reserva::getStatus).isEqualTo(reserva.getStatus());
            assertThat(reservaCriada).extracting(Reserva::getDataHorarioReserva).isEqualTo(reserva.getDataHorarioReserva());
