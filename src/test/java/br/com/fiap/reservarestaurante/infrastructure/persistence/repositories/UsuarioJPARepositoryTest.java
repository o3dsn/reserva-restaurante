...
class UsuarioJPARepositoryTest {
    ...
    void devePermitirCriarUsuario() {
        ...
        assertThat(usuarioArmazenado).isInstanceOf(UsuarioJPAEntity.class).isNotNull().isEqualTo(usuario);
    ...
    class Buscar {
        ...
        void devePermitirBuscarUsuarioPorId() {
            ...
            when(usuarioJPARepository.findById(String.valueOf(any(String.class)))).thenReturn(Optional.of(usuario));
