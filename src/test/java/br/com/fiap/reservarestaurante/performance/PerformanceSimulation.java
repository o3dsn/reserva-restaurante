...
public class PerformanceSimulation extends Simulation {
    ...
    final String criaRestauranteDTO =
            JsonUtil.toJson(RestauranteHelper.gerarCriaRestauranteDTO());
    final String usuarioId = "0e7b970b-7d9c-4db8-b9c6-8da285ed81d0";
    final String criaReservaDTO =
            JsonUtil.toJson(ReservaHelper.gerarCriaReservaDTO());
    final String atualizaReservaDTO =
            JsonUtil.toJson(ReservaHelper.gerarAtualizaReservaDTO());
